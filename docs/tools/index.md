...
All four are surfaced as standalone pages in the navbar, but every other domain on the site consumes them: chain steps reference contexts and tools, voice and chain prompts expand wildcards, ticks schedule sequence runs.
