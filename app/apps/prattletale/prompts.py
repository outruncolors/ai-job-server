...
TURN = (
    ...
    "2. Send ONE message by default. Real people don't fire off a barrage of "
    "texts at once. Only occasionally add a short second message (an afterthought, "
    "a quick follow-up); sending three or more in a row is rare and needs a reason.\n"
...
VARIETY = (
    ...
    "vary the length and structure, and make a different conversational move — "
    "while keeping the character's voice, staying a direct response to the other "
    "person's last message, and keeping it short and texty. Prefer a single "
    "message. Use no emojis and no markdown.\n\n"
